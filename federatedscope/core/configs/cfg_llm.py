...
def extend_llm_cfg(cfg):
    ...
    cfg.llm.adapter.clusters_file = '' 
    cfg.llm.adapter.clusters = [] 
    cfg.llm.adapter.round_budget = 0 
    cfg.llm.adapter.target_per_round = 0
    cfg.llm.adapter.boundaries = []
    cfg.llm.adapter.round_physical= []
    cfg.llm.adapter.sample_num_per_adapter= []
    ...
    cfg.llm.adapter.cluster_runtime.schedule_file = ''
    cfg.llm.adapter.ema_beta = 0.9
    # ---------------------------------------------------------------------- #

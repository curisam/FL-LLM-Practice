...
# ✅ 053번 ckpt 경로만 여기서 지정
CKPT="checkpoints_1.0_local_only/local_only_tldr_choice_qwen_client_003.ckpt"

EVALOUTDIR="exp/tldr/choice_qwen/cluster/local_only_1.0/raw/src_3"
OUTDIR="exp/tldr/choice_qwen/cluster/local_only_1.0/raw/src_3"

...
class Client(BaseClient):
    ...
    def __init__(self,
        ...
        # #멀티프로세스에서 모든 rank가 동시에 파일 쓰기를 하면 로그가 섞여 망가짐. 그래서 오직 rank0만 eval_results.log, system_metrics.log 등을 기록.
        # if not is_main:
        #     try:
        #         # 모니터가 들고 있던 파일 핸들러 닫고, 파일 기록 비활성화. 
        ...
        # # outdir이 sub_exp/... 라면 상위로 강제 고정 (최종 한 번 더). 실제로 바뀌는 거 없는거 같음.
        # self._force_single_outdir()

...
class Client(BaseClient):
    ...
    def __init__(self,
        ...
        self._force_single_outdir()
        logger.info(f"[DEBUG] msg_handlers for Client #{self.ID}: {self.msg_handlers}")
    ...
    def callback_funcs_for_evaluate(self, message: Message):
        ...
        logger.info(f"[DEBUG] is_main={is_main}, raw eval_metrics in ctx={getattr(self.trainer.ctx,'eval_metrics',None)}, merged metrics={metrics}")

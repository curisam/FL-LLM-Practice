...
class Client(BaseClient):
    ...
    def __init__(self,
        ...
        #  accelerate가 있으면 그걸로, 없으면 RANK/LOCAL_RANK 환경변수로 메인(rank0) 판정.
        is_main = True
        try:
    ...
    def run_standalone(self): #안쓰이는 거 같음.
        """
    ...
    """
    2025-08-21 17:40:06 (federatedscope.core.workers.client:594) INFO: [DEBUG] is_main=True, raw ctx.eval_metrics=None, merged metrics init={}
    2025-08-21 17:40:06 (federatedscope.core.workers.client:594) INFO: [DEBUG] is_main=True, raw ctx.eval_metrics=None, merged metrics init={}
    2025-08-21 17:40:06 (federatedscope.core.workers.client:594) INFO: [DEBUG] is_main=True, raw ctx.eval_metrics=None, merged metrics init={}
    2025-08-21 17:40:06 (federatedscope.core.workers.client:594) INFO: [DEBUG] is_main=True, raw ctx.eval_metrics=None, merged metrics init={}
    ...
    2025-08-21 17:40:12 (federatedscope.core.workers.client:594) INFO: [DEBUG] is_main=True, raw ctx.eval_metrics=None, merged metrics init={}
    ...
    2025-08-21 17:40:12 (federatedscope.core.workers.client:594) INFO: [DEBUG] is_main=True, raw ctx.eval_metrics=None, merged metrics init={}
    Special tokens have been added in the vocabulary, make sure the associated word embeddings are fine-tuned or trained.
    2025-08-21 17:40:12 (federatedscope.llm.trainer.reward_choice_trainer:217) INFO: Dataloader for 'val' has been reset and recreated. (sharded=True, world_size=4, rank=0, local_count=3, total=11)
    2025-08-21 17:40:12 (federatedscope.llm.trainer.trainer:345) INFO: Re-creating Accelerator for the new round.
    Special tokens have been added in the vocabulary, make sure the associated word embeddings are fine-tuned or trained.
    Special tokens have been added in the vocabulary, make sure the associated word embeddings are fine-tuned or trained.
    Special tokens have been added in the vocabulary, make sure the associated word embeddings are fine-tuned or trained.
    2025-08-21 17:40:12 (federatedscope.llm.trainer.reward_choice_trainer:217) INFO: Dataloader for 'val' has been reset and recreated. (sharded=True, world_size=4, rank=1, local_count=3, total=11)
    2025-08-21 17:40:12 (federatedscope.llm.trainer.trainer:345) INFO: Re-creating Accelerator for the new round.
    2025-08-21 17:40:12 (federatedscope.llm.trainer.reward_choice_trainer:217) INFO: Dataloader for 'val' has been reset and recreated. (sharded=True, world_size=4, rank=3, local_count=2, total=11)
    2025-08-21 17:40:12 (federatedscope.llm.trainer.trainer:345) INFO: Re-creating Accelerator for the new round.
    2025-08-21 17:40:12 (federatedscope.llm.trainer.reward_choice_trainer:217) INFO: Dataloader for 'val' has been reset and recreated. (sharded=True, world_size=4, rank=2, local_count=3, total=11)
    2025-08-21 17:40:12 (federatedscope.llm.trainer.trainer:345) INFO: Re-creating Accelerator for the new round.
    2025-08-21 17:40:13 (federatedscope.core.trainers.trainer:425) INFO: [agg debug] using_accel=True, world=4, rank=0, local_total=3
    2025-08-21 17:40:13 (federatedscope.core.trainers.trainer:425) INFO: [agg debug] using_accel=True, world=4, rank=1, local_total=3
    2025-08-21 17:40:13 (federatedscope.core.trainers.trainer:425) INFO: [agg debug] using_accel=True, world=4, rank=2, local_total=3
    2025-08-21 17:40:13 (federatedscope.core.trainers.trainer:425) INFO: [agg debug] using_accel=True, world=4, rank=3, local_total=2
    2025-08-21 17:40:13 (federatedscope.llm.trainer.reward_choice_trainer:543) INFO: [val|final] total=11, loss_sum=7.792813, avg_loss=0.708438, seen=11, correct=6, acc=0.545455
    2025-08-21 17:40:13 (federatedscope.llm.trainer.trainer:635) INFO: Accelerator object has been deleted.
    2025-08-21 17:40:13 (federatedscope.llm.trainer.trainer:635) INFO: Accelerator object has been deleted.
    2025-08-21 17:40:13 (federatedscope.llm.trainer.trainer:635) INFO: Accelerator object has been deleted.
    2025-08-21 17:40:13 (federatedscope.llm.trainer.trainer:635) INFO: Accelerator object has been deleted.
    2025-08-21 17:40:14 (federatedscope.core.workers.client:631) INFO: [DEBUG][after val] eval_metrics            = {}
    2025-08-21 17:40:14 (federatedscope.core.workers.client:632) INFO: [DEBUG][after val] metrics (merged so far) = {}
    2025-08-21 17:40:14 (federatedscope.core.workers.client:633) INFO: [DEBUG][after val] ctx.eval_metrics        = {}
    ...
    def callback_funcs_for_evaluate(self, message: Message):
        ...
        raw_ctx = getattr(self.trainer.ctx, 'eval_metrics', None) #None인 상황




        logger.info(f"[DEBUG] is_main={is_main}, raw ctx.eval_metrics={raw_ctx}, merged metrics init={metrics}") #INFO: [DEBUG] is_main=True, raw ctx.eval_metrics=None, merged metrics init={}

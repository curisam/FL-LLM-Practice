...
class Client(BaseClient):
    ...
    def __init__(self,
        ...
        self.msg_buffer = {'train': dict(), 'eval': dict()} #내부 비밀 셰어링(ss) 조각 수집이나, (이 예시에서는) 거의 쓰이지 않는 train/eval 키만 가집니다
        ...
        # === 중복 기록 방지 마커들 ===. 평가(eval) 또는 학습(train) 결과가 동일 라운드에 중복 기록되는 것 방지

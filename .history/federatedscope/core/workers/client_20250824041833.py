...
class Client(BaseClient):
    ...
    def callback_funcs_for_model_para(self, message: Message):
        ...
        _dump_queue_snapshot(self.comm_manager, tag=f"MODELPARA:entry r={round}", drain=True, filter_state=None)
        ...
        _dump_queue_snapshot(self.comm_manager, tag=f"MODELPARA:after-train r={self.state}", drain=True, filter_state=None)        
        ...
        _dump_queue_snapshot(self.comm_manager, tag=f"MODELPARA:after-send r={self.state}", drain=True, filter_state=None)
    ...
    def callback_funcs_for_evaluate(self, message: Message):
        ...
        try:
            ...
            for split in self._cfg.eval.split:  #['val', 'test']
                ...
                _dump_queue_snapshot(self.comm_manager, tag=f"EVAL:after-{split} r={self.state}", drain=True, filter_state=None)
        ...
        if is_main:
            _dump_queue_snapshot(self.comm_manager, tag=f"EVAL:after-monitor r={self.state}", drain=True, filter_state=None)
        ...
        print("############################ Before ############################")
        print(len(self.comm_manager.comm_queue))
        _dump_queue_snapshot(self.comm_manager, tag=f"EVAL:before-send r={self.state}", drain=True, filter_state=None)
        ...
        print("############################ After ############################")
        print(len(self.comm_manager.comm_queue))
        _dump_queue_snapshot(self.comm_manager, tag=f"EVAL:after-send r={self.state}", drain=True, filter_state=None)

...
class LLMMultiLoRAClient(Client):
    ...
    def callback_funcs_for_model_para(self, message: Message):
        ...
        if self._cfg.llm.adapter.local_only: #False. “클라이언트별” LoRA: Adapter_{client_id}를 활성화.
            # This is client-wise
            ...
            if self._cfg.llm.adapter.warmup.use and \
                ...
                adapter_idx = self.adapter_idx #val셋으로 각 어댑터를 평가해서 val_avg_loss가 가장 작은 어댑터 후보를 뽑고(동률이면 리스트에 모음), 그 중 랜덤으로 하나 선택.
            else:

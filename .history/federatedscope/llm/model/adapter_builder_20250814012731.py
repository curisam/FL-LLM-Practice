...
class AdapterModel(nn.Module):
    ...
    def state_dict(self, return_trainable=True, *args, **kwargs): #기존 PEFT 클래스: **학습 대상(주로 LoRA A/B, modules_to_save 등)**만 골라 반환.
        if return_trainable:
            return self.get_trainable_state_dict()
        else:
            return self.model.state_dict(*args, **kwargs) #backbone, lora 전부 내보냄.

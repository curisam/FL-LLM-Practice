...
CFG="fedbiscuit_script/tldr/tldr_choice_qwen_fusion_moe_count_avg_config_u3.yaml"
...
run_one () {
  ...
  local save_path="checkpoints_1.0/tldr_choice_qwen_fusionmoe_count_avg_u3_${ema}.ckpt"
  local outdir_path="exp/tldr/choice_qwen/gfl/fusionmoe_count_avg_u3_1.0_${ema}"

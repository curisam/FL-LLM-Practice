...
MAIN_PORT=29500
CFG1="fedbiscuit_script/tldr/finetune_centralize.yaml"
...
run_one () {
  ...
  local ckpt_path="checkpoints_1.0/lr_${lr}_step_${step}/final_tldr_choice_qwen_centralize_round_200.ckpt"
  local eval_outdir="exp/tldr/choice_qwen/pfl/lr_${lr}_step_${step}/centralize_1.0/raw"
  local outdir="exp/tldr/choice_qwen/pfl/lr_${lr}_step_${step}/centralize_1.0"
...
LR_LIST=("1e-5")        # 필요하면 "1e-7" 추가
STEP_LIST=(1 5 15)      # 필요하면 30 추가

...
CFG1="fedbiscuit_script/tldr/tldr_choice_qwen_centralize_1.0.yaml"
...
run_one () {
  ...
  local save_to="checkpoints_1.0/lr_${lr_tag}_step_${step}/tldr_choice_qwen_centralize.ckpt"
  local outdir="exp/tldr/choice_qwen/centralize_1.0/lr_${lr_tag}_step_${step}"
...
# LR_LIST=("1e-5" "1e-7") 
LR_LIST=("1e-5")       
STEP_LIST=(10 20 30)          # 원하는 local_update_steps 값들로 수정

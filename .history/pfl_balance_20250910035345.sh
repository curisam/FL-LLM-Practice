...
CFG1="fedbiscuit_script/tldr/finetune_fedbiscuit_u7_balance.yaml"
CFG2="fedbiscuit_script/tldr/finetune_fedbiscuit_u5_balance.yaml"
CFG3="fedbiscuit_script/tldr/finetune_fedbiscuit_u3_balance.yaml"

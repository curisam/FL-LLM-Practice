...
CFG="fedbiscuit_script/tldr/tldr_choice_qwen_fusion_moe_config_u3.yaml"

# 여러 값 테스트
EMAS=(0.9 0.5 0.7 0.3 0.1 0.0)  

run_one () {
  local ema="$1"
  
  # EMA 값을 문자열로 처리하여 그대로 경로에 반영
  local save_path="checkpoints_1.0/tldr_choice_qwen_fusionmoe_u3_${ema}.ckpt"
  local outdir_path="exp/tldr/choice_qwen/gfl/fusionmoe_u3_1.0_${ema}"

...
# CFG2="fedbiscuit_script/tldr/finetune_fedbis_oracle_u5_plain.yaml"
CFG3="fedbiscuit_script/tldr/finetune_fedbis_oracle_u9_plain.yaml"
CFG4="fedbiscuit_script/tldr/finetune_fedbis_oracle_u7_plain.yaml"

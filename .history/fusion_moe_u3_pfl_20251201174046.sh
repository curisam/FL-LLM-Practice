...
run_one () {
  ...
  # 동적으로 경로 업데이트
  local load_grouping_weights_path="exp/gfl/fusionmoe_u3_1.0_${ema}/grouping_weights_round160_beta${ema}.json"
  local pretrained_model_path="checkpoints_1.0/final_tldr_choice_qwen_fusionmoe_u3_${ema}_round_180.ckpt"

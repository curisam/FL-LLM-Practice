...
export TORCH_SHOW_CPP_STACKTRACES=1Humorous0
...
# CFG1="fedbiscuit_script/tldr/tldr_choice_qwen_fedbiscuit_u3_1.0_plain.yaml"
# CFG2="fedbiscuit_script/tldr/tldr_choice_qwen_fedbiscuit_u5_1.0_plain.yaml"
# CFG3="fedbiscuit_script/tldr/tldr_choice_qwen_fedbiscuit_u7_1.0_plain.yaml"
# CFG4="fedbiscuit_script/tldr/tldr_choice_qwen_fedbiscuit_u9_1.0_plain.yaml"

CFG="fedbiscuit_script/tldr/tldr_choice_qwen_fedbiscuit_u4_1.0_plain.yaml"

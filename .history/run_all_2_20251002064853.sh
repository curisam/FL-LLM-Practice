...
ACCEL="fedbiscuit_script/accelerator_config_bf16_ver2.yaml"
BASE_OUT="exp/tldr/choice_qwen/cluster/local_only_1.0/raw"

# ---- 직렬 루프: 001..053 ----
for i in $(seq 27 53); do
  SRC=$(printf "%03d" "$i")
  CKPT_REL="checkpoints_1.0_local_only/official/local_only_tldr_choice_qwen_client_${SRC}.ckpt"
